function [loadings] = J_variable_projection(theta, J, varargin)
    % functioon [loadings] = J_variable_projection(theta, J, varargin)
    %
    ...
    for iter = 1:maxiter
        ...
        B = J'*Bf;  % Passing it back to the original space
